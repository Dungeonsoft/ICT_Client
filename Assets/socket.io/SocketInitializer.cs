...
namespace socket.io {
    ...
    public class SocketInitializer : MonoBehaviour {
        ...
        IEnumerator InitCore(UniRx.IObserver<Socket> observer, UniRx.CancellationToken cancelToken) {
            ...
            var webSocketTrigger = FindObjectOfType<SocketManager>().GetWebSocketTrigger(BaseUrl);
            if (webSocketTrigger == null || !webSocketTrigger.IsConnected) {
                ...
                if (textIndex != -1) {
                    ...
                    Debug.Log("Json: " + json + " __:: Json End!!!");
                ...
                if (webSocketTrigger == null) {
                    ...
                    FindObjectOfType<SocketManager>().RegisterWebSocketTrigger(BaseUrl, webSocketTrigger);
